...
export async function ensureIndustryDatabase(vertical: string = "banking") {
...
export async function ensureCustomerTable(vertical: string = "banking") {
  const databaseName = vertical
...
export async function getIndustryPrismaClient(vertical: string = "banking") {
  const databaseName = vertical
